...
public class LEDSubsystem extends SubsystemBase {
  ...
  private LiftSubsystem led_lift;
  
  public LEDSubsystem(/*LiftSubsystem lift*/) {
    //led_lift = lift;
    // PWM port 9
  ...
  public void periodic() {
    ...
    //SmartDashboard.putNumber("LED Angle", getAngleLED());
  }
  ...
  public void manualMotionMagicLift(double move){
    double moveConstant = 10.0;
    int moveValue = (int)(move * moveConstant);
    testConst = testConst + moveValue;
  }

  /*
  public double getAngleLED(){
    return led_lift.getAngle();
  }
  */
